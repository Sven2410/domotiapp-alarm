...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ee=/'/g,we=/"/g,Te=/^(?:script|style|textarea|title)$/i,de=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),p=de(1),Ft=de(2),qt=de(3),w=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),Se=new WeakMap,A=E.createTreeWalker(E,129);function je(s,e){if(!le(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return xe!==void 0?xe.createHTML(e):e}var _t=(s,e)=>{let t=s.length-1,i=[],o,n=e===2?"<svg>":e===3?"<math>":"",r=H;for(let c=0;c<t;c++){let l=s[c],a,u,h=-1,f=0;for(;f<l.length&&(r.lastIndex=f,u=r.exec(l),u!==null);)f=r.lastIndex,r===H?u[1]==="!--"?r=ke:u[1]!==void 0?r=Ae:u[2]!==void 0?(Te.test(u[2])&&(o=RegExp("</"+u[2],"g")),r=k):u[3]!==void 0&&(r=k):r===k?u[0]===">"?(r=o??H,h=-1):u[1]===void 0?h=-2:(h=r.lastIndex-u[2].length,a=u[1],r=u[3]===void 0?k:u[3]==='"'?we:Ee):r===we||r===Ee?r=k:r===ke||r===Ae?r=H:(r=k,o=void 0);let m=r===k&&s[c+1].startsWith("/>")?" ":"";n+=r===H?l+ut:h>=0?(i.push(a),l.slice(0,h)+ze+l.slice(h)+x+m):l+x+(h===-2?c:m)}return[je(s,n+(s[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},D=class s{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let n=0,r=0,c=e.length-1,l=this.parts,[a,u]=_t(e,t);if(this.el=s.createElement(a,i),A.currentNode=this.el.content,t===2||t===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(o=A.nextNode())!==null&&l.length<c;){if(o.nodeType===1){if(o.hasAttributes())for(let h of o.getAttributeNames())if(h.endsWith(ze)){let f=u[r++],m=o.getAttribute(h).split(x),S=/([.?@])?(.*)/.exec(f);l.push({type:1,index:n,name:S[2],strings:m,ctor:S[1]==="."?ie:S[1]==="?"?oe:S[1]==="@"?ne:j}),o.removeAttribute(h)}else h.startsWith(x)&&(l.push({type:6,index:n}),o.removeAttribute(h));if(Te.test(o.tagName)){let h=o.textContent.split(x),f=h.length-1;if(f>0){o.textContent=Z?Z.emptyScript:"";for(let m=0;m<f;m++)o.append(h[m],P()),A.nextNode(),l.push({type:2,index:++n});o.append(h[f],P())}}}else if(o.nodeType===8)if(o.data===Ce)l.push({type:2,index:n});else{let h=-1;for(;(h=o.data.indexOf(x,h+1))!==-1;)l.push({type:7,index:n}),h+=x.length-1}n++}}static createElement(e,t){let i=E.createElement("template");return i.innerHTML=e,i}};function T(s,e,t=s,i){if(e===w)return e;let o=i!==void 0?t._$Co?.[i]:t._$Cl,n=R(e)?void 0:e._$litDirective$;return o?.constructor!==n&&(o?._$AO?.(!1),n===void 0?o=void 0:(o=new n(s),o._$AT(s,t,i)),i!==void 0?(t._$Co??=[])[i]=o:t._$Cl=o),o!==void 0&&(e=T(s,o._$AS(s,e.values),o,i)),e}var se=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,o=(e?.creationScope??E).importNode(t,!0);A.currentNode=o;let n=A.nextNode(),r=0,c=0,l=i[0];for(;l!==void 0;){if(r===l.index){let a;l.type===2?a=new L(n,n.nextSibling,this,e):l.type===1?a=new l.ctor(n,l.name,l.strings,this,e):l.type===6&&(a=new re(n,this,e)),this._$AV.push(a),l=i[++c]}r!==l?.index&&(n=A.nextNode(),r++)}return A.currentNode=E,o}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},L=class s{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,o){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=T(this,e,t),R(e)?e===d||e==null||e===""?(this._$AH!==d&&this._$AR(),this._$AH=d):e!==this._$AH&&e!==w&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ft(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==d&&R(this._$AH)?this._$AA.nextSibling.data=e:this.T(E.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,o=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=D.createElement(je(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===o)this._$AH.p(t);else{let n=new se(o,this),r=n.u(this.options);n.p(t),this.T(r),this._$AH=n}}_$AC(e){let t=Se.get(e.strings);return t===void 0&&Se.set(e.strings,t=new D(e)),t}k(e){le(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,o=0;for(let n of e)o===t.length?t.push(i=new s(this.O(P()),this.O(P()),this,this.options)):i=t[o],i._$AI(n),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=ye(e).nextSibling;ye(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},j=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,o,n){this.type=1,this._$AH=d,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=d}_$AI(e,t=this,i,o){let n=this.strings,r=!1;if(n===void 0)e=T(this,e,t,0),r=!R(e)||e!==this._$AH&&e!==w,r&&(this._$AH=e);else{let c=e,l,a;for(e=n[0],l=0;l<n.length-1;l++)a=T(this,c[i+l],t,l),a===w&&(a=this._$AH[l]),r||=!R(a)||a!==this._$AH[l],a===d?e=d:e!==d&&(e+=(a??"")+n[l+1]),this._$AH[l]=a}r&&!o&&this.j(e)}j(e){e===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ie=class extends j{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===d?void 0:e}},oe=class extends j{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==d)}},ne=class extends j{constructor(e,t,i,o,n){super(e,t,i,o,n),this.type=5}_$AI(e,t=this){if((e=T(this,e,t,0)??d)===w)return;let i=this._$AH,o=e===d&&i!==d||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==d&&(i===d||o);o&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},re=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}};var mt=ae.litHtmlPolyfillSupport;mt?.(D,L),(ae.litHtmlVersions??=[]).push("3.3.3");var Ne=(s,e,t)=>{let i=t?.renderBefore??e,o=i._$litPart$;if(o===void 0){let n=t?.renderBefore??null;i._$litPart$=o=new L(e.insertBefore(P(),n),n,void 0,t??{})}return o._$AI(s),o};var pe=globalThis,g=class extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ne(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return w}};g._$litElement$=!0,g.finalized=!0,pe.litElementHydrateSupport?.({LitElement:g});var gt=pe.litElementPolyfillSupport;gt?.({LitElement:g});(pe.litElementVersions??=[]).push("4.2.2");var y="domotiapp-alarm-card",ce="domotiapp-alarm-card-editor",Ve="domotiapp-alarm-editor",Oe="DomotiApp Alarm",Me="https://github.com/Sven2410/domotiapp-alarm",v="domotiapp_alarm",_=Object.freeze({get:`${v}/alarms/get`,save:`${v}/alarms/save`,setEnabled:`${v}/alarms/set_enabled`,skipNext:`${v}/alarms/skip_next`,delete:`${v}/alarms/delete`,stop:`${v}/alarms/stop`,clearMessage:`${v}/alarms/clear_message`,search:`${v}/sound/search`,entities:`${v}/entities/list`,previewStart:`${v}/preview/start`,subscribe:`${v}/updates/subscribe`}),F="#026FA1";var vt="07:00";var bt=["uri","name","media_type","image"],$t="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",yt="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var xt="Music Assistant Wekker",kt="Verlichting Wekker";function q(){return{id:null,name:"",time:vt,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function He(s){let e=q();return!s||typeof s!="object"?e:{id:typeof s.id=="string"?s.id:null,name:typeof s.name=="string"?s.name:"",time:he(s.time)?s.time:e.time,days:Array.isArray(s.days)?[...s.days]:[],enabled:s.enabled!==!1,sound:U(s.sound),endless:null,speaker:typeof s.speaker=="string"?s.speaker:"",volume_pct:Number.isInteger(s.volume_pct)?s.volume_pct:e.volume_pct,light:s.light&&typeof s.light=="object"?{entity_id:s.light.entity_id,brightness_pct:Number.isInteger(s.light.brightness_pct)?s.light.brightness_pct:60}:null}}function U(s){if(!s||typeof s!="object"||Array.isArray(s)||typeof s.uri!="string"||!s.uri)return null;let e={};for(let t of bt)e[t]=s[t]===void 0?null:s[t];return e}function he(s){if(typeof s!="string"||s.length!==5||s[2]!==":")return!1;let e=Number(s.slice(0,2)),t=Number(s.slice(3));return!/^\d\d$/.test(s.slice(0,2))||!/^\d\d$/.test(s.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function ue(s){let e=[];return!s||typeof s!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof s.name!="string"||!s.name.trim())&&e.push("een naam"),he(s.time)||e.push("een geldige tijd"),s.speaker||e.push("een speaker"),(!s.sound||!s.sound.uri)&&e.push("een geluid"),(!Number.isInteger(s.volume_pct)||s.volume_pct<1||s.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Pe(s){let e={name:(s.name||"").trim(),time:s.time,days:[...new Set(s.days||[])].sort((t,i)=>t-i),enabled:s.enabled!==!1,sound:U(s.sound),speaker:s.speaker,volume_pct:s.volume_pct,light:s.light?{entity_id:s.light.entity_id,brightness_pct:s.light.brightness_pct}:null};return s.id&&(e.id=s.id),e}function Re(s,e){let t=new Set(s||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((i,o)=>i-o)}function De(s){return he(s)&&s.slice(0,2)==="02"?$t:null}function Le(s){return s===!1?yt:null}function Ue(s){return typeof s?.endless=="boolean"?s.endless:null}function Y(s,e){let t=e==="lamp",i=t?kt:xt,o=t?"lampen":"speakers";return!s||typeof s!="object"?`De lijst met ${o} is niet op te halen.`:s.label_exists===!1?`Het label '${i}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${o} zetten die als wekker mogen dienen.`:Array.isArray(s.entities)&&s.entities.length>0?null:Number(s.filtered_out)>0?t?`De entiteiten met het label '${i}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${o} met het label '${i}'.`}function Ie(s,e){return Y(e,"speaker")!==null?!1:ue(s).ok}var Et=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],wt=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],I="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",St="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",zt="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",N=class extends g{constructor(){super(),this._concept=q(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?He(this.wekker):q(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:_.previewStart,speaker:this._concept.speaker,sound:U(this._concept.sound),volume_pct:this._concept.volume_pct}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:_.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let i=await this.hass.callWS(t);this._treffers=i.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:U(e),endless:Ue(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=ue(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:_.save,person:this.person,alarm:Pe(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return p`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
  ...
  `);var Ke="person",Ct="Kies een persoon in de kaartinstellingen.",We="De gekozen persoon bestaat niet meer.",Tt="De opgeslagen wekkers van deze persoon zijn onleesbaar.",_s=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function Ge(s){if(!s||typeof s!="object"||Array.isArray(s))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=s.person;if(e==null||e==="")return{...s};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Ke}.`))throw new Error(`'${e}' zit niet in het domein ${Ke}. Kies een persoon, zoals person.sven.`);return{...s}}function Be(s){return{type:`custom:${s}`}}function Ze(s,e){return s?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:We,isFout:!0}:{soort:"ontbreekt",tekst:Ct,isFout:!1}}function Fe(s,e){return s==="not_found"?We:s==="home_assistant_error"?Tt:e||"Er ging iets mis bij het ophalen van de wekkers."}var jt="home-assistant";function qe({leesRegistry:s,definities:e,waarschuw:t=()=>{},plan:i=(l,a)=>setTimeout(l,a),nu:o=()=>Date.now(),marker:n=jt,intervalMs:r=20,maxWachtMs:c=1e4}){let l=o();function a(){let f=s();if(!f)return!1;for(let[m,S]of e)try{f.get(m)||f.define(m,S)}catch(_e){t(`kon ${m} niet registreren: ${_e&&_e.message}`)}return!0}function u(){let f=s();return!f||!f.get(n)?!1:a()}if(u())return!0;let h=()=>{if(!u()){if(o()-l>=c){t(`${n} is na ${c} ms niet verschenen; de kaart wordt alsnog geregistreerd`),a();return}i(h,r)}};return i(h,r),!1}var Nt=["ma","di","wo","do","vr","za","zo"],Ye="Geen wekkers ingesteld",Vt="Eenmalig",Ot="Eenmalig \u2014 afgelopen",Mt="Morgen overgeslagen",Je="Geen wekker actief",Xe="Stoppen",Ht="Er is een melding over deze wekker, maar de tekst ontbreekt.";function Pt(s){return!Array.isArray(s)||s.length===0?Vt:[...new Set(s)].sort((t,i)=>t-i).map(t=>Nt[t-1]??"?").join(" ")}function Rt(s,e){return!s||Array.isArray(s.days)&&s.days.length>0?!1:Date.parse(s?.one_shot_at??"")<=e}function Qe(s,e){return Rt(s,e)?Ot:s?.skip_next?Mt:Pt(s?.days)}function et(s){let e=s?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:Ht,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function tt(s,e){let t=[...new Set((e??[]).filter(r=>typeof r=="string"))];if(t.length===0)return null;let i=t.map(r=>(s??[]).find(c=>c?.id===r)).filter(Boolean),o=i.map(r=>r.name).filter(Boolean),n=[...new Set(i.map(r=>r.time).filter(Boolean))];return{ids:t,naam:o.length?o.join(" en "):"Wekker",tijd:n.join(" en ")}}var Dt="1.0.0",Lt="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",Ut="M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z",st="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",It="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",J=(s,e="icoon")=>p`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    ...
    >
      ...
      ${e.length===0?p`<div class="mededeling">${Ye}</div>`:e.map(i=>this._rij(i,t))}
      <div class="voet">
        <span class="volgende">
          ${this._toestand.next_fire?.text??Je}
        </span>
        <button
          class="icoonknop"
    ...
    `}_rij(e,t){let i=et(e),o=!!e.enabled;return p`
      <div class="rij ${o?"":"uit"}">
        <button
          class="tikvlak"
          type="button"
  ...
  `);var V=class V extends g{constructor(){super(...arguments);b(this,"_label",t=>t.name==="person"?"Persoon":t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?d:p`
      <div class="uitleg">
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let i={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}};b(V,"properties",{hass:{attribute:!1},_config:{state:!0}}),b(V,"styles",C`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--secondary-text-color);
      font-size: var(--ha-font-size-s, 12px);
    }
  `),b(V,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}}]);var fe=V;qe({leesRegistry:()=>globalThis.customElements,definities:[[y,K],[ce,fe],[Ve,N]],waarschuw:s=>console.warn(`${y}: ${s}`)});window.customCards=window.customCards||[];window.customCards.some(s=>s.type===y)||window.customCards.push({type:y,name:Oe,description:`Wekkerkaart van DomotiApp (v${Dt}).`,preview:!1,documentationURL:Me});

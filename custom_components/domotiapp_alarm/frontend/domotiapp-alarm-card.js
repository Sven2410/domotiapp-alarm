...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ae=/'/g,Ee=/"/g,Ce=/^(?:script|style|textarea|title)$/i,de=n=>(e,...t)=>({_$litType$:n,strings:e,values:t}),p=de(1),qt=de(2),Yt=de(3),E=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),ze=new WeakMap,w=A.createTreeWalker(A,129);function Te(n,e){if(!le(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return xe!==void 0?xe.createHTML(e):e}var ft=(n,e)=>{let t=n.length-1,i=[],s,o=e===2?"<svg>":e===3?"<math>":"",r=M;for(let h=0;h<t;h++){let l=n[h],a,u,c=-1,g=0;for(;g<l.length&&(r.lastIndex=g,u=r.exec(l),u!==null);)g=r.lastIndex,r===M?u[1]==="!--"?r=ye:u[1]!==void 0?r=we:u[2]!==void 0?(Ce.test(u[2])&&(s=RegExp("</"+u[2],"g")),r=y):u[3]!==void 0&&(r=y):r===y?u[0]===">"?(r=s??M,c=-1):u[1]===void 0?c=-2:(c=r.lastIndex-u[2].length,a=u[1],r=u[3]===void 0?y:u[3]==='"'?Ee:Ae):r===Ee||r===Ae?r=y:r===ye||r===we?r=M:(r=y,s=void 0);let f=r===y&&n[h+1].startsWith("/>")?" ":"";o+=r===M?l+ut:c>=0?(i.push(a),l.slice(0,c)+je+l.slice(c)+x+f):l+x+(c===-2?h:f)}return[Te(n,o+(n[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},R=class n{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let o=0,r=0,h=e.length-1,l=this.parts,[a,u]=ft(e,t);if(this.el=n.createElement(a,i),w.currentNode=this.el.content,t===2||t===3){let c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(s=w.nextNode())!==null&&l.length<h;){if(s.nodeType===1){if(s.hasAttributes())for(let c of s.getAttributeNames())if(c.endsWith(je)){let g=u[r++],f=s.getAttribute(c).split(x),z=/([.?@])?(.*)/.exec(g);l.push({type:1,index:o,name:z[2],strings:f,ctor:z[1]==="."?ie:z[1]==="?"?se:z[1]==="@"?oe:T}),s.removeAttribute(c)}else c.startsWith(x)&&(l.push({type:6,index:o}),s.removeAttribute(c));if(Ce.test(s.tagName)){let c=s.textContent.split(x),g=c.length-1;if(g>0){s.textContent=Z?Z.emptyScript:"";for(let f=0;f<g;f++)s.append(c[f],D()),w.nextNode(),l.push({type:2,index:++o});s.append(c[g],D())}}}else if(s.nodeType===8)if(s.data===Se)l.push({type:2,index:o});else{let c=-1;for(;(c=s.data.indexOf(x,c+1))!==-1;)l.push({type:7,index:o}),c+=x.length-1}o++}}static createElement(e,t){let i=A.createElement("template");return i.innerHTML=e,i}};function C(n,e,t=n,i){if(e===E)return e;let s=i!==void 0?t._$Co?.[i]:t._$Cl,o=P(e)?void 0:e._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(n),s._$AT(n,t,i)),i!==void 0?(t._$Co??=[])[i]=s:t._$Cl=s),s!==void 0&&(e=C(n,s._$AS(n,e.values),s,i)),e}var ne=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??A).importNode(t,!0);w.currentNode=s;let o=w.nextNode(),r=0,h=0,l=i[0];for(;l!==void 0;){if(r===l.index){let a;l.type===2?a=new L(o,o.nextSibling,this,e):l.type===1?a=new l.ctor(o,l.name,l.strings,this,e):l.type===6&&(a=new re(o,this,e)),this._$AV.push(a),l=i[++h]}r!==l?.index&&(o=w.nextNode(),r++)}return w.currentNode=A,s}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},L=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=C(this,e,t),P(e)?e===d||e==null||e===""?(this._$AH!==d&&this._$AR(),this._$AH=d):e!==this._$AH&&e!==E&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):gt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==d&&P(this._$AH)?this._$AA.nextSibling.data=e:this.T(A.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=R.createElement(Te(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{let o=new ne(s,this),r=o.u(this.options);o.p(t),this.T(r),this._$AH=o}}_$AC(e){let t=ze.get(e.strings);return t===void 0&&ze.set(e.strings,t=new R(e)),t}k(e){le(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,s=0;for(let o of e)s===t.length?t.push(i=new n(this.O(D()),this.O(D()),this,this.options)):i=t[s],i._$AI(o),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=$e(e).nextSibling;$e(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},T=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,o){this.type=1,this._$AH=d,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=d}_$AI(e,t=this,i,s){let o=this.strings,r=!1;if(o===void 0)e=C(this,e,t,0),r=!P(e)||e!==this._$AH&&e!==E,r&&(this._$AH=e);else{let h=e,l,a;for(e=o[0],l=0;l<o.length-1;l++)a=C(this,h[i+l],t,l),a===E&&(a=this._$AH[l]),r||=!P(a)||a!==this._$AH[l],a===d?e=d:e!==d&&(e+=(a??"")+o[l+1]),this._$AH[l]=a}r&&!s&&this.j(e)}j(e){e===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ie=class extends T{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===d?void 0:e}},se=class extends T{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==d)}},oe=class extends T{constructor(e,t,i,s,o){super(e,t,i,s,o),this.type=5}_$AI(e,t=this){if((e=C(this,e,t,0)??d)===E)return;let i=this._$AH,s=e===d&&i!==d||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,o=e!==d&&(i===d||s);s&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},re=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){C(this,e)}};var mt=ae.litHtmlPolyfillSupport;mt?.(R,L),(ae.litHtmlVersions??=[]).push("3.3.3");var Ve=(n,e,t)=>{let i=t?.renderBefore??e,s=i._$litPart$;if(s===void 0){let o=t?.renderBefore??null;i._$litPart$=s=new L(e.insertBefore(D(),o),o,void 0,t??{})}return s._$AI(n),s};var pe=globalThis,_=class extends k{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ve(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return E}};_._$litElement$=!0,_.finalized=!0,pe.litElementHydrateSupport?.({LitElement:_});var _t=pe.litElementPolyfillSupport;_t?.({LitElement:_});(pe.litElementVersions??=[]).push("4.2.2");var $="domotiapp-alarm-card",he="domotiapp-alarm-card-editor",Ne="domotiapp-alarm-editor",Oe="DomotiApp Alarm",He="https://github.com/Sven2410/domotiapp-alarm",b="domotiapp_alarm",m=Object.freeze({get:`${b}/alarms/get`,save:`${b}/alarms/save`,setEnabled:`${b}/alarms/set_enabled`,delete:`${b}/alarms/delete`,stop:`${b}/alarms/stop`,clearMessage:`${b}/alarms/clear_message`,search:`${b}/sound/search`,entities:`${b}/entities/list`,previewStart:`${b}/preview/start`,subscribe:`${b}/updates/subscribe`}),F="#026FA1";function Me(n){let e=typeof n?.name=="string"?n.name.trim():"",t=typeof n?.time=="string"?n.time.trim():"";return e&&t?`Wil je de wekker "${e}" van ${t} verwijderen?`:e?`Wil je de wekker "${e}" verwijderen?`:t?`Wil je de wekker van ${t} verwijderen?`:"Wil je deze wekker verwijderen?"}var vt="07:00";var bt=["uri","name","media_type","image"],kt="Let op: deze tijd bestaat twee nachten per jaar niet, of twee keer. Bij de overgang naar zomertijd wordt het uur van 02:00 tot 03:00 overgeslagen; die nacht gaat deze wekker niet af. Bij de overgang naar wintertijd komt dat uur twee keer voorbij; die nacht gaat hij twee keer af. Kies een tijd v\xF3\xF3r 02:00 of n\xE1 03:00 als dat een probleem is.",$t="Dit geluid stopt van zichzelf. Een los nummer is na een paar minuten voorbij; daarna is het stil. Kies een afspeellijst of een radiostation als de wekker moet blijven spelen tot je hem uitzet.";var xt="Music Assistant Wekker",yt="Verlichting Wekker";function q(){return{id:null,name:"",time:vt,days:[],enabled:!0,sound:null,endless:null,speaker:"",volume_pct:40,light:null}}function De(n){let e=q();return!n||typeof n!="object"?e:{id:typeof n.id=="string"?n.id:null,name:typeof n.name=="string"?n.name:"",time:ce(n.time)?n.time:e.time,days:Array.isArray(n.days)?[...n.days]:[],enabled:n.enabled!==!1,sound:U(n.sound),endless:null,speaker:typeof n.speaker=="string"?n.speaker:"",volume_pct:Number.isInteger(n.volume_pct)?n.volume_pct:e.volume_pct,light:n.light&&typeof n.light=="object"?{entity_id:n.light.entity_id,brightness_pct:Number.isInteger(n.light.brightness_pct)?n.light.brightness_pct:60}:null}}function U(n){if(!n||typeof n!="object"||Array.isArray(n)||typeof n.uri!="string"||!n.uri)return null;let e={};for(let t of bt)e[t]=n[t]===void 0?null:n[t];return e}function ce(n){if(typeof n!="string"||n.length!==5||n[2]!==":")return!1;let e=Number(n.slice(0,2)),t=Number(n.slice(3));return!/^\d\d$/.test(n.slice(0,2))||!/^\d\d$/.test(n.slice(3))?!1:e>=0&&e<=23&&t>=0&&t<=59}function ue(n){let e=[];return!n||typeof n!="object"?{ok:!1,ontbreekt:["alles"]}:((typeof n.name!="string"||!n.name.trim())&&e.push("een naam"),ce(n.time)||e.push("een geldige tijd"),n.speaker||e.push("een speaker"),(!n.sound||!n.sound.uri)&&e.push("een geluid"),(!Number.isInteger(n.volume_pct)||n.volume_pct<1||n.volume_pct>100)&&e.push("een volume tussen 1 en 100"),{ok:e.length===0,ontbreekt:e})}function Pe(n){let e={name:(n.name||"").trim(),time:n.time,days:[...new Set(n.days||[])].sort((t,i)=>t-i),enabled:n.enabled!==!1,sound:U(n.sound),speaker:n.speaker,volume_pct:n.volume_pct,light:n.light?{entity_id:n.light.entity_id,brightness_pct:n.light.brightness_pct}:null};return n.id&&(e.id=n.id),e}function Re(n,e){let t=new Set(n||[]);return t.has(e)?t.delete(e):t.add(e),[...t].sort((i,s)=>i-s)}function Le(n){return ce(n)&&n.slice(0,2)==="02"?kt:null}function Ue(n){return n===!1?$t:null}function Ie(n){return typeof n?.endless=="boolean"?n.endless:null}function Y(n,e){let t=e==="lamp",i=t?yt:xt,s=t?"lampen":"speakers";return!n||typeof n!="object"?`De lijst met ${s} is niet op te halen.`:n.label_exists===!1?`Het label '${i}' bestaat nog niet. De beheerder moet dat label aanmaken en op de ${s} zetten die als wekker mogen dienen.`:Array.isArray(n.entities)&&n.entities.length>0?null:Number(n.filtered_out)>0?t?`De entiteiten met het label '${i}' zijn geen lampen.`:"De gelabelde speakers zijn geen Music Assistant-speakers, of ze kunnen geen volume instellen.":`Er zijn nog geen ${s} met het label '${i}'.`}function We(n,e){return Y(e,"speaker")!==null?!1:ue(n).ok}var At=[[1,"ma"],[2,"di"],[3,"wo"],[4,"do"],[5,"vr"],[6,"za"],[7,"zo"]],Et=[["","Alles"],["playlist","Afspeellijsten"],["radio","Radio"],["artist","Artiesten"],["album","Albums"],["track","Nummers"],["podcast","Podcasts"]],I="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",zt="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",jt="M6,2H18V8H18V8L14,12L18,16V16H18V22H6V16H6V16L10,12L6,8V8H6V2M16,16.5L12,12.5L8,16.5V20H16V16.5M12,11.5L16,7.5V4H8V7.5L12,11.5Z",V=class extends _{constructor(){super(),this._concept=q(),this._zoekterm="",this._soort="",this._treffers=null,this._zoekt=!1,this._melding=null,this._speelt=!1,this._bezig=!1,this._afmeldenVoorbeeld=null,this._opEscape=e=>{e.key==="Escape"&&this._annuleren()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._opEscape,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._opEscape,!0),this._stopVoorbeeld()}willUpdate(e){e.has("wekker")&&(this._concept=this.wekker?De(this.wekker):q(),this._treffers=null,this._zoekterm="",this._melding=null)}_zet(e){this._concept={...this._concept,...e}}async _startVoorbeeld(){if(!(this._speelt||!this.hass)){if(!this._concept.speaker||!this._concept.sound){this._melding={tekst:"Kies eerst een speaker en een geluid.",fout:!0};return}this._melding=null;try{this._afmeldenVoorbeeld=await this.hass.connection.subscribeMessage(()=>{},{type:m.previewStart,speaker:this._concept.speaker,sound:U(this._concept.sound),volume_pct:this._concept.volume_pct,light:this._concept.light??null}),this._speelt=!0}catch(e){this._melding={tekst:e?.message??"Het voorbeeld kon niet starten.",fout:!0}}}}_stopVoorbeeld(){if(this._afmeldenVoorbeeld){try{this._afmeldenVoorbeeld()}catch(e){console.warn(`domotiapp-alarm-editor: afmelden mislukt: ${e?.message??e}`)}this._afmeldenVoorbeeld=null}this._speelt=!1}async _zoek(){let e=(this._zoekterm||"").trim();if(!(!e||!this.hass)){this._zoekt=!0,this._melding=null;try{let t={type:m.search,query:e,limit:20};this._soort&&(t.media_types=[this._soort]);let i=await this.hass.callWS(t);this._treffers=i.results??[]}catch(t){this._treffers=[],this._melding={tekst:t?.message??"Zoeken is mislukt.",fout:!0}}finally{this._zoekt=!1}}}_kiesGeluid(e){this._zet({sound:U(e),endless:Ie(e)}),this._treffers=null}async _opslaan(){if(this._bezig||!this.hass)return;let e=ue(this._concept);if(!e.ok){this._melding={tekst:`Er ontbreekt nog ${e.ontbreekt.join(", ")}.`,fout:!0};return}this._bezig=!0;try{let t=await this.hass.callWS({type:m.save,person:this.person,alarm:Pe(this._concept)});this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-opgeslagen",{detail:{toestand:t},bubbles:!0,composed:!0}))}catch(t){this._melding={tekst:t?.message??"Opslaan is mislukt.",fout:!0}}finally{this._bezig=!1}}_annuleren(){this._stopVoorbeeld(),this.dispatchEvent(new CustomEvent("editor-dicht",{bubbles:!0,composed:!0}))}_svg(e){return p`<svg class="icoon" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <div class="blok">
        ...
        ${s?p`<div class="uitleg">${this._svg(I)}<span>${s}</span></div>`:p`<select
              id="speaker"
              .value=${e.speaker}
    ...
    `}};v(V,"properties",{hass:{attribute:!1},person:{attribute:!1},wekker:{attribute:!1},entiteiten:{attribute:!1},_concept:{state:!0},_zoekterm:{state:!0},_soort:{state:!0},_treffers:{state:!0},_zoekt:{state:!0},_melding:{state:!0},_speelt:{state:!0},_bezig:{state:!0}}),v(V,"styles",S`
    :host {
      --domotiapp-accent: ${j(F)};
      display: block;
  ...
  `);var Ke="person",St="Kies een persoon in de kaartinstellingen.",Be="De gekozen persoon bestaat niet meer.",Ct="De opgeslagen wekkers van deze persoon zijn onleesbaar.",vn=Object.freeze(["grid_options","layout_options","view_layout","visibility"]);function Ge(n){if(!n||typeof n!="object"||Array.isArray(n))throw new Error("De kaartconfig ontbreekt of is geen object.");let e=n.person;if(e==null||e==="")return{...n};if(typeof e!="string")throw new Error("'person' moet een entity-ID zijn, zoals person.sven.");if(!e.startsWith(`${Ke}.`))throw new Error(`'${e}' zit niet in het domein ${Ke}. Kies een persoon, zoals person.sven.`);return{...n}}function Ze(n){return{type:`custom:${n}`}}function Fe(n,e){return n?e?{soort:"ok",tekst:null,isFout:!1}:{soort:"weg",tekst:Be,isFout:!0}:{soort:"ontbreekt",tekst:St,isFout:!1}}function qe(n,e){return n==="not_found"?Be:n==="home_assistant_error"?Ct:e||"Er ging iets mis bij het ophalen van de wekkers."}var Tt="home-assistant";function Ye({leesRegistry:n,definities:e,waarschuw:t=()=>{},plan:i=(l,a)=>setTimeout(l,a),nu:s=()=>Date.now(),marker:o=Tt,intervalMs:r=20,maxWachtMs:h=1e4}){let l=s();function a(){let g=n();if(!g)return!1;for(let[f,z]of e)try{g.get(f)||g.define(f,z)}catch(fe){t(`kon ${f} niet registreren: ${fe&&fe.message}`)}return!0}function u(){let g=n();return!g||!g.get(o)?!1:a()}if(u())return!0;let c=()=>{if(!u()){if(s()-l>=h){t(`${o} is na ${h} ms niet verschenen; de kaart wordt alsnog geregistreerd`),a();return}i(c,r)}};return i(c,r),!1}var Vt=["ma","di","wo","do","vr","za","zo"],Nt="Geen wekkers ingesteld",Ot="Eenmalig",Ht="Eenmalig \u2014 afgelopen",Mt="Geen wekker actief",Je="Stoppen",Dt="Er is een melding over deze wekker, maar de tekst ontbreekt.";function Pt(n){return!Array.isArray(n)||n.length===0?Ot:[...new Set(n)].sort((t,i)=>t-i).map(t=>Vt[t-1]??"?").join(" ")}function Rt(n,e){return!n||Array.isArray(n.days)&&n.days.length>0?!1:Date.parse(n?.one_shot_at??"")<=e}function Xe(n,e){return Rt(n,e)?Ht:Pt(n?.days)}function Qe(n){let e=n?.last_message;return!e||typeof e!="object"||Array.isArray(e)?null:{tekst:typeof e.text=="string"&&e.text.trim()?e.text:Dt,severity:e.severity==="error"?"error":"notice",isFout:e.severity==="error",kind:typeof e.kind=="string"?e.kind:null}}function et(n){let e=n?.alarms;if(!Array.isArray(e)||e.length===0)return Nt;let t=n?.next_fire?.text;return typeof t=="string"&&t.trim()?t:Mt}function tt(n,e){let t=[...new Set((e??[]).filter(r=>typeof r=="string"))];if(t.length===0)return null;let i=t.map(r=>(n??[]).find(h=>h?.id===r)).filter(Boolean),s=i.map(r=>r.name).filter(Boolean),o=[...new Set(i.map(r=>r.time).filter(Boolean))];return{ids:t,naam:s.length?s.join(" en "):"Wekker",tijd:o.join(" en ")}}var Lt="1.0.3",Ut="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",It="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z",nt="M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",Wt="M13,14H11V9H13M13,18H11V16H13M1,21H23L12,2L1,21Z",J=(n,e="icoon")=>p`<svg class=${e} viewBox="0 0 24 24" aria-hidden="true">
    ...
    `}};v(W,"properties",{hass:{attribute:!1},_config:{state:!0},_toestand:{state:!0},_fout:{state:!0},_bevestigVoor:{state:!0},_bezig:{state:!0},_tijdelijkeMelding:{state:!0},_editorVoor:{state:!0},_entiteiten:{state:!0}}),v(W,"styles",S`
  ...
  `);var N=class N extends _{constructor(){super(...arguments);v(this,"_label",t=>t.name==="person"?"Persoon":t.name)}setConfig(t){this._config={...t}}render(){return!this._config||!this.hass?d:p`
      ...
      ></ha-form>
    `}_gewijzigd(t){t.stopPropagation();let i={...this._config,...t.detail.value};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}};v(N,"properties",{hass:{attribute:!1},_config:{state:!0}}),v(N,"styles",S`
    .uitleg {
      padding: 0 0 12px 0;
      color: var(--secondary-text-color);
      font-size: var(--ha-font-size-s, 12px);
    }
  `),v(N,"_SCHEMA",[{name:"person",required:!0,selector:{entity:{filter:{domain:"person"}}}}]);var ge=N;Ye({leesRegistry:()=>globalThis.customElements,definities:[[$,W],[he,ge],[Ne,V]],waarschuw:n=>console.warn(`${$}: ${n}`)});window.customCards=window.customCards||[];window.customCards.some(n=>n.type===$)||window.customCards.push({type:$,name:Oe,description:`Wekkerkaart van DomotiApp (v${Lt}).`,preview:!1,documentationURL:He});
